package com.smiles.smilesFlightFinder.service;
...
public class FlightService {
    ...
    private static final String API_URL_TEMPLATE = "https://api-air-flightsearch-green.smiles.com.br/v1/airlines/search?originAirportCode=%s&destinationAirportCode=%s&departureDate=%s&adults=%d";
    private static final OkHttpClient client = new OkHttpClient();



    public List<Map<String, Object>> searchFlights(String originAirportCode, String arrivalAirportCode, String departureDate, Integer adults) {
        String url = String.format(API_URL_TEMPLATE, originAirportCode, arrivalAirportCode, departureDate, adults);
